    ...
    def get_symbol_state(
        ...
        sections = {
            ...
            "range": {
                ...
                "distance_from_high_20": latest.get("distance_from_high_20"),
                "distance_from_low_20": latest.get("distance_from_low_20"),
                "distance_from_sma_20": latest.get("distance_from_sma_20"),
                "distance_from_sma_50": latest.get("distance_from_sma_50"),
                "distance_from_sma_200": latest.get("distance_from_sma_200"),
                "range_position_20": latest.get("range_position_20"),
            },
            "volume": {
